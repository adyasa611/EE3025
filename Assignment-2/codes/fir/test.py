...
plt.savefig('../figure/fir/fir_lowpass.pdf')
plt.savefig('../figure/fir/fir_lowpass.eps')
#plt.show()
#subprocess.run(shlex.split("termux-open ../figure/fir/fir_lowpass.pdf"))
...
plt.savefig('../figure/fir/fir_bandpass.pdf')
plt.savefig('../figure/fir/fir_bandpass.eps')
#plt.show()

#subprocess.run(shlex.split("termux-open ../figure/fir/fir_bandpass.pdf"))
#print(fir_coeff)

np.savetxt('fir_coeff.dat',hbp,delimiter=',')
